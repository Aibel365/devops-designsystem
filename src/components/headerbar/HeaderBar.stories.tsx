...
// import { Avatar } from "designsystemet/components";
...
const handleLogout = () => {
    alert("The user log out triggered");
};

const linkCallback = (link: string) => {
    alert("Clicked a link with link text " + link);
};
...
// export const WithCallbackInsteadOfHref: Story = {
//     args: {
//         ...Default.args,
//         titleLink: undefined,
//         logoLink: undefined,
...
export const WithCustomMenuContent: Story = {
    args: {
        ...
        //             //     <Button variant="popover" sizeVariant="popover">
        //             //       Pop
        //             //     </Button>
        //             //     <Button variant="popover" sizeVariant="popover">
        //             //       Pop
