...
export const SubHeaderBar = ({
  ...
  return (
    <header className="ads:flex ads:items-center ads:justify-between ads:w-full ads:h-14">
      ...
      <div className="ads:flex-1 ads:justify-end">
        {projectNumber && (
          <div className="ads:flex ads:items-center ads:w-fit ads:h-7 ads:sm:h-6 ads:py-0 ads:px-6 ads:border-100 ads:bg-indigo-400 ads:text">
            {projectNumber}
          </div>
        )}
      </div>
